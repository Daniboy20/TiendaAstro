...
testimonials:
  - name: "Carlos Mendoza"
    ...
    content: "WearFit se ha convertido en una de mis tiendas favoritas. La calidad de la ropa es excelente y los precios realmente valen la pena. Siempre encuentro prendas modernas y cómodas para cualquier ocasión."

  - name: "Sofía Ramírez"
    designation: "Compradora online"
    avatar: "/images/avatar-sm.png"
    content: "Me encantó la experiencia de compra en WearFit. El proceso fue rápido, los productos llegaron en perfecto estado y la calidad superó mis expectativas. Definitivamente volveré a comprar."

  - name: "Daniel Ortega"
    designation: "Amante de la moda urbana"
    avatar: "/images/avatar-sm.png"
    content: "WearFit ofrece marcas increíbles y ropa auténtica con diseños muy modernos. Me gustó mucho la variedad de estilos y lo fácil que fue encontrar exactamente lo que buscaba."

  - name: "Valeria Cruz"
    designation: "Cliente satisfecha"
    avatar: "/images/avatar-sm.png"
    content: "La atención al cliente fue excelente y las prendas tienen una calidad impresionante. Se nota que WearFit selecciona cuidadosamente cada producto para ofrecer lo mejor a sus clientes."
